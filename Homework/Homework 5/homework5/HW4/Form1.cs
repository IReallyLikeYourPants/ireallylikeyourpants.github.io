...
namespace HW4
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            bIsto1 = new Bitmap(pictureBox3.Width, pictureBox3.Height);
            gIsto1 = Graphics.FromImage(bIsto1);
            gIsto1.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.HighQuality;
            ...
            foreach (double chiave in magia.Keys)
            {
                ...
                Rectangle Window2 = new Rectangle(intervalli * 6, bIsto1.Height - (bIsto1.Height/ massimo * magia[chiave]), (int)beginning * 2, bIsto1.Height /massimo * magia[chiave]);
                gIsto1.DrawRectangle(Pens.Black, Window2);
                gIsto1.FillRectangle(Brushes.MistyRose, Window2);
                intervalli++;
            }
            pictureBox2.Image = bIsto;
            pictureBox3.Image = bIsto1;
        }
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (double chiave in magia.Keys)
            {
                Rectangle Window1 = new Rectangle(0, 5 * intervalli,  bIsto.Width / massimo * magia[chiave] , (int)beginning * 2);
                gIsto.DrawRectangle(Pens.Black, Window1);
                gIsto.FillRectangle(Brushes.MistyRose, Window1); Rectangle Window2 = new Rectangle(intervalli * 6, bIsto1.Height - (bIsto1.Height / massimo * magia[chiave]), (int)beginning * 2, bIsto1.Height / massimo * magia[chiave]);
                gIsto1.DrawRectangle(Pens.Black, Window2);
                gIsto1.FillRectangle(Brushes.MistyRose, Window2);
                intervalli++;
            }
